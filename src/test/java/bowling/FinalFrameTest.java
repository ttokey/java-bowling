...
public class FinalFrameTest {
    ...
    @ParameterizedTest
    @MethodSource("toPrint_score3개")
    public void toPrint_score3개(int score1, int score2, int score3, String expectString) throws Exception {
        // given
        Frame finalFrame = new FinalFrame();
    ...
    @ParameterizedTest
    @MethodSource("toPrint_score2개")
    public void toPrint_score2개(int score1, int score2, String expectString) throws Exception {
        // given
        Frame finalFrame = new FinalFrame();
    ...
    @ParameterizedTest
    @MethodSource("toPrint_score1개")
    public void toPrint_score1개(int score1, String expectString) throws Exception {
        // given
        Frame finalFrame = new FinalFrame();
